    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="booking p-5">
             ...
             <button class="btn btn-lg btn-primary btn-block text-uppercase" >USER</button>
                 </form>
             <a  href="AdminLogin.jsp"   class="btn btn-lg btn-primary btn-block text-uppercase" >ADMIN</a>
